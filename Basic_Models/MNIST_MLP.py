...
"""
    this code is related to training a Multi-Layer Perceptron Neural Network to clasify
...
EVAL_FREQ = 100     # Evaluation after EVAL_FREQ number of iterations
...
model = tf.keras.Sequential([
        layers.Dense(512, input_shape=[784,], activation=tf.nn.relu),
...
for itr in range(N_ITERS):
    ...
    pred = train_step(train_images, train_labels)
