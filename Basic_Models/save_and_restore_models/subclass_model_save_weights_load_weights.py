...
model.save_weights(filepath="subclass_model_weights_1.h5")
...
model.save_weights(filepath="subclass_model_weights_2.h5")
y_pred = model.predict(x=x_test) # evaluate model on test split
y_pred = np.argmax(y_pred, axis=1)
acc.update_state(y_test, y_pred) # calculate accuracy metric
...
model.save_weights(filepath="subclass_model_weights_3.h5")
y_pred = model.predict(x=x_test) # evaluate model on test split
y_pred = np.argmax(y_pred, axis=1)
acc.update_state(y_test, y_pred) # calculate accuracy metric
...
model.load_weights("subclass_model_weights_1.h5")
y_pred = model.predict(x=x_test) # evaluate model on test split
y_pred = np.argmax(y_pred, axis=1)
acc.update_state(y_test, y_pred) # calculate accuracy metric
...
model.load_weights("subclass_model_weights_2.h5")
y_pred = model.predict(x=x_test) # evaluate model on test split
y_pred = np.argmax(y_pred, axis=1)
acc.update_state(y_test, y_pred) # calculate accuracy metric
...
model.load_weights("subclass_model_weights_3.h5")
y_pred = model.predict(x=x_test) # evaluate model on test split
y_pred = np.argmax(y_pred, axis=1)
acc.update_state(y_test, y_pred) # calculate accuracy metric
